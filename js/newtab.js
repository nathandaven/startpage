// code from https://github.com/gdh1995/vimium-c-helpers/blob/master/newtab/newtab.js
// all credit goes to the Vimiuum C helper extension!

"use strict";
var isNotChrome_ = "object" === typeof browser && !!browser,
focusContent_ = "0" !== localStorage.focusNewTabContent, url_ = localStorage.newTabUrl || "index.html",
...
useTabs = function (tabs) {
  ...
  chrome_.tabs[focusContent_ ? "create" : "update"]({ url: url_, openerTabId: openerTab && openerTab.id }, callback);
};

isRedirecting_ ? isNotChrome_ && localStorage.setOpener ? chrome_.tabs.query({currentWindow: true}, useTabs)
